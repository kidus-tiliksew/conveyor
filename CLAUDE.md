...
the consolidated restatement of v1.0–v1.40 plus worker first-activity
liveness; the body §§1–20 is normative, §21 is the change record). When code
and spec disagree, the spec wins; spec changes go by amendment with a version
bump (§21), never silent edits.
