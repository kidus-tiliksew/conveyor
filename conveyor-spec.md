...
*End of specification. v1.33 accepted July 20, 2026; all prior amendments remain in force, and §21.32 re-resolves pinned harness snapshots on queue re-entry. Subsequent changes proceed by amendment with version bumps.*
