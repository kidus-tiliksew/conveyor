...
*End of specification. v1.34 accepted July 21, 2026; all prior amendments remain in force, and §21.33 delegates the spec stage over MCP with triage briefs and non-normative spec diagrams. Subsequent changes proceed by amendment with version bumps.*
