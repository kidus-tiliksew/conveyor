...
*End of specification. v1.39 accepted July 22, 2026; all prior amendments remain in force, §21.37 defines the canonical lifecycle state machines with normative transition tables, and §21.38 defines the serialized task command plane. Subsequent changes proceed by amendment with version bumps.*
