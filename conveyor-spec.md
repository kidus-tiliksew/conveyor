...
*End of specification. v1.40 accepted July 22, 2026; all prior amendments remain in force, §21.37 defines the canonical lifecycle state machines with normative transition tables, §21.38 defines the serialized task command plane, and §21.39 defines task bodies as GitHub-flavored Markdown. Subsequent changes proceed by amendment with version bumps.*
