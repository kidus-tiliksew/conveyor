    ...
    >
      <div className="flex items-start gap-2">
        ...
        <div className="text-xs leading-5 text-muted">
          ...
          <p>
            {status.queue_context === 'interrupted'
              ? 'This work was interrupted and may require recovery.'
              : 'This queued work has never started.'}
          </p>
          <p className="mt-1 flex items-center gap-1">
            <CircleCheck className="size-3" /> Restarting an enrolled worker normally reuses its saved credential; no
            new pairing token is needed.
          </p>
        </div>
      </div>
    </section>
