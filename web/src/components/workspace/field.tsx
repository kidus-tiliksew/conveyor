      ...
      <label className="block">
        <span className="mb-1 flex items-center gap-1.5 text-[11px] font-medium uppercase tracking-wider text-muted">
          ...
          {hint && (
            <span
              title={hint}
              className="inline-flex size-3.5 cursor-help items-center justify-center rounded-full border border-edge text-[9px] font-semibold normal-case tracking-normal text-faint"
            >
              ?
            </span>
          )}
