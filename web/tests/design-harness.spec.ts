...
const setupContract = {
  ...
  review: {
    seats: [
      { model: 'gpt-5.6-sol', harness: 'codex', effort: 'high' },
      { model: 'claude-opus-5', harness: 'claude', effort: 'medium' },
    ],
  },
...
const activity = [
  summary(
    { latest_stage: 'triage', last_event_at: ago(2) },
    {
      id: 'task-260731-a1b2c3',
      state: 'queued',
      next_stage: 'triage',
      class: 'bug',
      title: 'Board column counts drift after a task is cancelled mid-review',
      source: 'github:kidus-tiliksew/conveyor#418',
      branch: 'conveyor/task-260731-a1b2c3',
    },
  ),
  summary(
    { latest_stage: 'triage', last_event_at: ago(41) },
    {
      id: 'task-260731-d4e5f6',
      state: 'running',
      class: 'chore',
      repo: 'conveyor-docs',
      title: 'Regenerate the MCP tool reference from the current server schema',
      source: 'cli',
      branch: 'conveyor-docs/task-260731-d4e5f6',
    },
  ),
  summary(
    { latest_stage: 'spec', last_event_at: ago(7) },
    {
      id: 'task-260731-773a10',
      state: 'running',
      class: 'feature',
      title: 'Requirement documents gain a confirmed-by attribution line',
      source: 'api',
      branch: 'conveyor/task-260731-773a10',
    },
  ),
  summary(
    { latest_stage: 'spec', last_event_at: ago(96), needs_attention: false },
    {
      id: 'task-260731-91aa02',
      state: 'queued',
      next_stage: 'spec',
      class: 'feature',
      hold: true,
      title: 'Planning session transcripts archive as artifacts on finalize',
      source: 'github:kidus-tiliksew/conveyor#401',
      branch: 'conveyor/task-260731-91aa02',
    },
  ),
  summary(
    { latest_stage: 'implement', last_event_at: ago(3) },
    {
      id: 'task-260731-4c8d1e',
      state: 'running',
      class: 'feature',
      title: 'Dependency-gated claiming derives blocked from the enforcement layer',
      source: 'github:kidus-tiliksew/conveyor#420',
      branch: 'conveyor/task-260731-4c8d1e',
    },
  ),
  summary(
    {
      latest_stage: 'implement',
      last_event_at: ago(55),
      stalled: {
        needed: true,
        reason: 'The worker child exited without a submission',
        last_failure: 'harness exited: status 1 — provider rejected the configured model',
      },
    },
    {
      id: 'task-260731-6f2b99',
      state: 'running',
      class: 'bug',
      title: 'Worktree containment fails when the repo has an active rebase',
      source: 'monitor',
      branch: 'conveyor/task-260731-6f2b99',
    },
  ),
  summary(
    {
      latest_stage: 'implement',
      last_event_at: ago(180),
      stalled: { needed: false, reason: '', blocking_task_ids: ['task-260731-4c8d1e'] },
    },
    {
      id: 'task-260731-08c5aa',
      state: 'queued',
      next_stage: 'implement',
      class: 'feature',
      title: 'Graph-walk context assembly reads lineage edges instead of the feed',
      source: 'api',
      branch: 'conveyor/task-260731-08c5aa',
  ...
  summary(
    { latest_stage: 'review', last_event_at: ago(1) },
    {
      id: 'task-260731-b31f47',
      state: 'running',
      class: 'feature',
      title: 'Blueprint materialization fans approved decompositions into child tasks',
      source: 'github:kidus-tiliksew/conveyor#399',
      branch: 'conveyor/task-260731-b31f47',
    },
  ),
  summary(
    {
      latest_stage: 'review',
      last_event_at: ago(22),
      review_diagnostics: [
        {
          ...
          review_round: 2,
          review_seat: 2,
          reason: 'claim active past the lease window',
        },
      ],
    },
    {
      id: 'task-260731-cc7712',
      state: 'running',
      class: 'bug',
      title: 'Review seats retain their assignment across a setup change',
      source: 'cli',
      branch: 'conveyor/task-260731-cc7712',
    },
  ),
  summary(
    { latest_stage: 'verify', last_event_at: ago(9) },
    {
      id: 'task-260731-2ad4b0',
      state: 'running',
      class: 'feature',
      title: 'Evidence-gated submit_for_review rejects an empty evidence set',
      source: 'github:kidus-tiliksew/conveyor#388',
      branch: 'conveyor/task-260731-2ad4b0',
    },
  ),
  summary(
    { latest_stage: 'review', last_event_at: ago(4), needs_attention: true },
    {
      id: 'task-260731-gate01',
      state: 'awaiting_human',
      class: 'feature',
      title: 'Activities surfaces read as one story instead of a machine log',
      source: 'github:kidus-tiliksew/conveyor#421',
      branch: 'conveyor/task-260731-gate01',
    },
  ),
  summary(
    { latest_stage: 'merge', last_event_at: ago(18), needs_attention: true },
    {
      id: 'task-260731-mrg001',
      state: 'approved',
      class: 'chore',
      title: 'Pin the worker harness argv snapshot into the dispatch record',
      source: 'cli',
      branch: 'conveyor/task-260731-mrg001',
    },
  ),
  summary(
    {
      latest_stage: 'triage',
      last_event_at: ago(240),
      needs_attention: true,
      forge_failure: {
        category: 'auth',
        detail: 'resource not accessible by integration',
        surface: 'issue publication',
        at: ago(240),
      },
    },
    {
      id: 'task-260731-park01',
      state: 'parked',
      class: 'question',
      title: 'Should monitor-created tasks inherit the source issue’s labels?',
      source: 'monitor',
      branch: 'conveyor/task-260731-park01',
    },
  ),
  summary(
    { latest_stage: 'merge', last_event_at: ago(320) },
    {
      id: 'task-260730-1af22a',
      state: 'merged',
      class: 'feature',
      title: 'Complete the blueprint materialization handoff',
      source: 'github:kidus-tiliksew/conveyor#377',
      branch: 'conveyor/task-260730-1af22a',
    },
  ),
  summary(
    { latest_stage: 'spec', last_event_at: ago(690) },
    {
      id: 'task-260729-55bd31',
      state: 'closed',
      class: 'bug',
      repo: 'conveyor-docs',
      title: 'Duplicate of #362 — closed without merging',
      source: 'api',
      branch: 'conveyor-docs/task-260729-55bd31',
    },
  ),
]
...
const gateDetail = {
  task: task({
    ...
    github: {
      task_id: 'task-260731-gate01',
      repository: 'kidus-tiliksew/conveyor',
      spec_version: 2,
      source: 'api',
      issue_number: 421,
      issue_url: 'https://github.com/kidus-tiliksew/conveyor/issues/421',
      state: 'published',
  ...
  jobs: [
    {
      ...
      stage: 'triage',
      harness: 'in-process',
      model_tier: 'openai/gpt-5.6-luna',
      runner: 'in-process',
      confinement: 'none',
      cost_usd: 0.03,
      tokens_in: 8200,
  ...
  events: [
    ...
    },
    {
      ...
      payload: {
        summary:
          'Classified as a feature against conveyor. Routing to spec with the §13.3 presentation constraints attached.',
      },
      at: ago(596),
    },
    {
    ...
    },
    {
      id: 5,
      task_id: 'task-260731-gate01',
      kind: 'github_issue.associated',
      actor_id: 'system',
      actor_role: 'system',
      payload: { issue_url: 'https://github.com/kidus-tiliksew/conveyor/issues/421' },
      at: ago(498),
    },
    {
      id: 6,
      ...
      payload: {
        summary:
          'Reworked the board card to a two-line identity block, folded the provenance and repo chips into a single footer, and moved the audit numbers behind hover. Added a regression test for the badge budget.',
      },
      at: ago(182),
    },
    {
      ...
      actor_id: 'system',
      actor_role: 'system',
      payload: { url: 'https://github.com/kidus-tiliksew/conveyor/pull/423' },
      at: ago(178),
    },
    {
      id: 8,
      ...
      actor_role: 'runner',
      payload: {
        review_work_order_id: 'wo-rev-1',
        review_round: 1,
        verdict: 'approve',
        summary: 'Approved',
        feedback: 'The card reads cleanly at 288px. Badge budget holds at two in every state I could construct.',
        review_seat: 1,
      },
      at: ago(104),
    },
    {
      ...
      actor_role: 'runner',
      payload: {
        review_work_order_id: 'wo-rev-2',
        review_round: 1,
        verdict: 'approve',
        summary: 'Approved',
        feedback: 'Verified the dependency tooltip still announces to screen readers after the markup change.',
        review_seat: 2,
      },
      at: ago(96),
    },
    {
      ...
      payload: {
        ...
        verdict: 'approve',
        summary: 'Unanimous',
        reviews: [{ review_work_order_id: 'wo-rev-1' }, { review_work_order_id: 'wo-rev-2' }],
      },
      at: ago(95),
    },
  ],
  interventions: [
    {
      ...
      comment: 'Spec covers the badge budget and the tooltip contract. Go.',
      at: ago(500),
    },
  ],
  work_orders: [
    {
      ...
      queue_entered_at: ago(430),
      queue_deadline: ago(-1000),
      redispatch_count: 0,
      cost_usd: 3.12,
      tokens_in: 410000,
      tokens_out: 52000,
  ...
  merge_readiness: {
    state: 'MERGEABLE',
    head_sha: 'a1b2c3d4',
    url: 'https://github.com/kidus-tiliksew/conveyor/pull/423',
    number: 423,
  },
}
  ...
  work_orders: [
    {
      ...
      model_enforcement: 'worker-pinned',
      required_effort: 'high',
      progress: 'Reading the diff against the materialization contract.',
      queue_entered_at: ago(16),
      queue_deadline: ago(-1000),
      redispatch_count: 0,
      cost_usd: 0.44,
      tokens_in: 71000,
...
async function mockAPIs(page: Page) {
  ...
  await page.route('**/v1/**', async (route: Route) => {
    ...
    if (url.pathname === '/v1/workspaces') {
      await route.fulfill({ json: [{ id: 'conveyor', name: 'Conveyor', config_version: 4, created_at: ago(9000) }] })
      return
    }
    ...
    if (detail) {
      await route.fulfill({ json: details[decodeURIComponent(detail[1])] ?? gateDetail })
      return
    }
...
for (const theme of ['light', 'dark'] as const) {
  test(`design harness ${theme}`, async ({ page }) => {
    ...
    await page.locator('.task-sheet-body').evaluate((node) => {
      node.scrollTop = 0
    })
    ...
    await page.getByLabel('Task content').evaluate((node) => {
      node.scrollTop = 0
    })
    await page.waitForTimeout(200)
