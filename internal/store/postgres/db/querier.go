...
type Querier interface {
	...
	GetWorkspaceForgeTokenForUse(ctx context.Context, workspaceID string) (WorkspaceForgeToken, error)
	GetWorkspaceForgeTokenStatus(ctx context.Context, workspaceID string) (GetWorkspaceForgeTokenStatusRow, error)
	...
	ListWorkspaceForgeTokensForRedaction(ctx context.Context) ([]WorkspaceForgeToken, error)
	...
	UpsertWorkspaceForgeToken(ctx context.Context, arg UpsertWorkspaceForgeTokenParams) (WorkspaceForgeToken, error)
	DeleteWorkspaceForgeToken(ctx context.Context, workspaceID string) (int64, error)
