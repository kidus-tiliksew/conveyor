-- Phase 8.3 audited replacement of an unapproved planning-bundle preview.
-- The event remains workspace-scoped because it projects bundle-to-document
-- lineage without belonging to any created task.
