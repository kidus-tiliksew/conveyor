-- Migration 110 was preserved from the operator-approved identity-password
-- history repair and recreates this constraint after migration 109. Restore
-- the forge-token audit kinds append-only after that migration has run.
