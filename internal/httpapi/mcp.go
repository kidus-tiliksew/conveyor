...
func mcpTools() []map[string]any {
	...
	return []map[string]any{
		...
		{"name": "get_work_order", "description": "Get the claimed order contract, spec, branch, feedback, artifacts, and review diff. Queued review authority is a live advisory peek and does not bind verdict validation until claim.", "inputSchema": object(identity, "work_order_id", "session_id")},
