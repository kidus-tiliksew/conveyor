...
func mcpTools() []map[string]any {
	...
	return []map[string]any{
		...
		{"name": "report_usage", "description": "Record cumulative self-reported token and cost usage; budget is enforced here.", "inputSchema": object(map[string]any{"work_order_id": str, "session_id": str, "tokens_in": num, "tokens_out": num, "cost_usd": num}, "work_order_id", "session_id", "tokens_in", "tokens_out", "cost_usd")},
